          ...
          child: ListView(
            ...
            children: [
              _buildMovieImageWithText(
                'Assets/p1.png',
                'Perajut Terakhir',
                'Film ini dapat rating ⭐ 8,0 dari penonton lho! Harus ditonton nih!',
              ),
              _buildMovieImageWithText(
                'Assets/p2.png',
                'Galaksi',
                'Film ini dapat rating ⭐ 9,5 dari penonton lho! Harus ditonton nih!',
              ),
              _buildMovieImageWithText(
                'Assets/p3.png',
                'Lembayung',
              ...
              _buildMovieImageWithText(
                'Assets/p4.png',
                'Agak lain',
                'Film ini dapat rating ⭐ 8,9 dari penonton lho! Harus ditonton nih!',
              ),
            ],
          ),
        ),
